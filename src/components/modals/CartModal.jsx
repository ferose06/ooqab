                    ...
                    <div className="tf-cart-totals-discounts">
                      ...
                      <h5 className="tf-totals-total-value">
                        <span className="price">
                          <span className="old-price" style={{ textDecoration: "line-through", display: "inline-block", marginRight: "8px", fontWeight: 400, color: "var(--secondary-2)", fontSize: "14px", lineHeight: "22px" }}>
