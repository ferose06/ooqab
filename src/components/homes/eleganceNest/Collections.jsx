  ...
  useEffect(() => {
    const fetchCollections = async () => {
      try {
        ...
        setCollectionItems(parsedProducts);
      } catch (error) {
                        ...
                        <div className="loobook-product">
                          ...
                          <div className="content">
                            <div className="info">
                              <a
                                href="#"
                                className="text-title text-line-clamp-1 link text-white"
                              >
                  ...
                  <div className="content">
                    <div className="archive-top">
                      <h4 className="title text-white">
                        <Link
                            to={`/shop-by-collections/${item.s_text}`}
                          className="link"
                    ...
                    <div className="archive-btn">
                        <Link to={`/shop-by-collections/${item.s_text}`} className="btn-line">
                        {item.btnText}
                      </Link>
                    </div>
                  </div>
