  ...
  return (
    ...
    >
      <div className="card-product-wrapper">
        ...
        {product.oldPrice ? (
          <div className="on-sale-wrap">
            <span className="on-sale-item">-{(((product.oldPrice - product.price)/product.oldPrice)*100).toFixed(0)}% OFF</span>
          </div>
        ) : (
          ""
        )}
      ...
      <div className="card-product-info">
        ...
        <span className="price">
          {product.oldPrice && (
            <span className="old-price"> AED {product.oldPrice.toFixed(2)}</span>
          )}{" "}
